    ...
    return ( 
        <div className="col-md-7 col-lg-8 p-3 g-3 mt-3 mx-auto shadow border border-dark rounded calc-box">
            <div className="row g-3 align-items-center justify-content-center mb-1">
                <div className="col-3">
                    <label htmlFor="current-gold-mat-id" className="col-form-label">Current gold material:</label>
                    <input type="number" id="current-gold-mat-id" className="form-control" name="currGoldMat" defaultValue={ascCalcData.currGoldMat} min="0" onChange={onChangeHandlerAscCalcData} />
                </div>
                <div className="col-3">
            ...
            <div className="row g-3 align-items-center justify-content-center mb-1">
                <div className="col-3">
                    <label htmlFor="required-gold-mat-id" className="col-form-label">Required gold material:</label>
                    <input type="number" id="required-gold-mat-id" className="form-control" name="reqGoldMat" defaultValue={ascCalcData.reqGoldMat} min="0" onChange={onChangeHandlerAscCalcData} />
                </div>
                <div className="col-3">
            ...
            <div className="row g-3 align-items-center text-center mt-1">
                <p>
                    Materials needed:<br/>
                    Gold: {ascCalcResults.neededGoldMat}<br/>
